...
public class CrosswordView extends JPanel {
	...
	private void initialize() {
		...
		btnCheck = new JButton("Check my Answers!", new ImageIcon(getClass().getClassLoader().getResource("resources/check_medium.png")));
		...
		btnPause = new JButton("Pause", new ImageIcon(getClass().getClassLoader().getResource("resources/pause_btn.png")));
		...
		btnSurrender = new JButton("Surrender", new ImageIcon(getClass().getClassLoader().getResource("resources/surrender.png")));
		...
		JButton btnBack = new JButton(new ImageIcon(getClass().getClassLoader().getResource("resources/back_small.png")));
	...
	class HintCounterLabel extends JLabel{
		...
		HintCounterLabel() {
			super();
			this.setText("00");
			super.setIcon(new ImageIcon(getClass().getClassLoader().getResource("resources/tip_big.png")));
		}
	}
