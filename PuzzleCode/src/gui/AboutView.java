...
public class AboutView extends JPanel {
	...
	private AboutView() {
		...
		btnBack.setIcon(new ImageIcon(AboutView.class.getResource("/resources/back.png")));
		...
		lblImg.setIcon(new ImageIcon(AboutView.class.getResource("/resources/crossword_small.jpg")));
