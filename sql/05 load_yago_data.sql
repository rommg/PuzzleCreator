LOAD DATA LOCAL INFILE  'c:\\Users\\duvid\\Documents\\PuzzleCreator\\sql\\filesToLoad\\yagoTypes.tsv'
INTO TABLE YAGO_TYPE
	fields terminated by '\t'
	lines terminated by '\n'
	(subject, predicate, object, answer, additional_information);

LOAD DATA LOCAL INFILE  'c:\\Users\\duvid\\Documents\\PuzzleCreator\\sql\\filesToLoad\\yagoFacts.tsv'
INTO TABLE YAGO_FACT
	fields terminated by '\t'
	lines terminated by '\n'
	(subject, predicate, object, is_subject);

LOAD DATA LOCAL INFILE  'c:\\Users\\duvid\\Documents\\PuzzleCreator\\sql\\filesToLoad\\yagoLiteralFacts.tsv'
