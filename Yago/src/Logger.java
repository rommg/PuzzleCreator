...
public class Logger {
	...
	public static int initialize(){
		logFile = new File(System.getProperty("user.home")
				+ System.getProperty("file.separator") + "desktop" + System.getProperty("file.separator")  
				+ "temp" + System.getProperty("file.separator") ,logFilename);
		boolean bRes;
		try{
			if (!logFile.getParentFile().exists()) // create directory of logFile
				logFile.getParentFile().mkdirs();
			if (logFile.exists()) // delete if exists, to start with clean log
				logFile.delete();
